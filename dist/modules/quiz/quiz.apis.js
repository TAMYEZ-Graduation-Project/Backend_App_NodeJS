...
class QuizApisManager {
    getQuizQustions = async ({ title, aiPrompt, }) => {
        try {
            ...
            throw new BadRequestException(`Failed to get quiz questions ❓❌, ${error.message}`);
        }
    };
}
